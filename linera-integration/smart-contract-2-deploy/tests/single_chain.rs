...
//! Integration testing for the smart_contract_2_deploy application.
...
async fn single_chain_test() {
    let (validator, module_id) =
        TestValidator::with_current_module::<smart_contract_2_deploy::SmartContract2DeployAbi, (), u64>().await;
